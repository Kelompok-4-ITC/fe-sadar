  ...
  return (
    <div className="flex flex-col gap-2 h-screen bg-sadar-second-white">
        ...
        <div className="w-full px-5">
          <div className="p-2 flex gap-1">
            ...
            <div className="flex flex-col gap-0 px-1 w-full">
              <h1 className="font-semibold text-t-black text-lg">Alamat Dituju</h1>
      ...
      <main className="px-5 flex flex-col gap-2 h-full pb-5">
        ...
        {/* Button Lanjut */}
        <Link to={"/drop-off/tahap-satu"} className="px-3 py-2 bg-sadar-primary-color hover:bg-sadar-fourth-black rounded-lg font-semibold text-lg text-t-white text-center">Proses Pesanan</Link>
      </main >
    </div >
  )
}
