  ...
  return (
    <div className="flex flex-col gap-2 h-screen bg-sadar-second-white">
      ...
      <main className="px-5 flex flex-col gap-2 h-full">
        ...
        {/* Button Lanjut */}
        <Link to={"/drop-off/lokasi"} className="px-3 py-2 bg-sadar-primary-color hover:bg-sadar-fourth-black rounded-lg font-semibold text-lg text-t-white text-center">Lanjut</Link>
      </main >
    </div >
  )
}
