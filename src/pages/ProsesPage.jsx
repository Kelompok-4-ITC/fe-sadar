      ...
      <div className="p-[10px] w-full h-fit border-0 rounded-[10px] shadow-[0px_4px_4px_0px_#00000025] bg-[#EBFBEE]">
        <div className="flex flex-col">
          ...
          <div className="font-semibold text-[15px] flex flex-row justify-between text-t-grey">
            <button
              type="button"
              className={`font-medium focus:font-semibold border-[2px] rounded-full w-[80px] h-[34px] border-t-grey focus:text-sadar-primary-color focus:border-sadar-primary-color ${filter === 'all' && 'text-sadar-primary-color'}`}
            ...
            <button
              type="button"
              className={`font-medium focus:font-semibold border-[2px] rounded-full w-[85px] h-[34px] border-t-grey focus:text-sadar-primary-color focus:border-sadar-primary-color ${filter === 'pickup' && 'text-sadar-primary-color'}`}
            ...
            <button
              type="button"
              className={`font-medium focus:font-semibold border-[2px] rounded-full w-[92px] h-[34px] border-t-grey focus:text-sadar-primary-color focus:border-sadar-primary-color ${filter === 'dropoff' && 'text-sadar-primary-color'}`}
          ...
          <div className="flex flex-col py-[10px] gap-[10px]">
            <div
              className={`shadow-[0px_4px_4px_0px_#00000025] border-0 rounded-[10px] ${filter === 'all' || filter === 'pickup' ? '' : 'hidden'}`}
            >
            ...
            {/* DropOff */}
            <div
              className={`shadow-[0px_4px_4px_0px_#00000025] border-0 rounded-[10px] ${filter === 'all' || filter === 'dropoff' ? '' : 'hidden'}`}
            >
              <div className="p-[10px] bg-sadar-primary-color border-0 rounded-t-[10px] flex flex-row justify-between">
                <div className="font-medium text-[13px]">
              ...
              <div className="flex flex-col justify-center pt-[15px] px-[15px] pb-[10px] items-center border-0 rounded-b-[10px] bg-sadar-second-white">
                <div className="flex flex-row items-center gap-[10px]">
                  <img src={DropOff} alt="" className="border-0 rounded-[10px]" />
