...
import IconToken from "../../img/icon-token.png";
  ...
  return (
    <>
      <div className="flex flex-col gap-[10px] pb-20">
        ...
        <section
          id="poster"
          className="border-b-2 border-dashed border-b-[#202020] w-full"
        >
        ...
        <section className="w-full relative px-[10px]">
          <input
            type="text"
            placeholder="Cari"
            className="px-[10px] border-[1px] border-sadar-second-black rounded-[10px] h-[40px] bg-t-white w-full pe-10"
            id="sarch"
          />
          <label
            htmlFor="search"
            className="absolute inset-y-0 end-4 flex items-center ps-4 cursor-pointer"
          >
            <img
              src={SearchIcon}
              alt="search"
        ...
        <section className="px-[10px] font-semibold text-[14px]">
          <section className="px-[10px] py-[5px] flex flex-row items-center border-[1px] rounded-[8px] border-black w-fit">
            <div className="pr-[5px]">poin anda</div>
            <div className="flex flex-row justify-center items-center border-l border-black border-dashed pl-[5px]">
              <div>1000</div>{" "}
              <div>
                <img src={IconToken} alt="" />
              </div>
            </div>
          </section>
        </section>
        ...
        {/* Main - List Product*/}
        <main className="flex flex-wrap gap-[15px] px-[10px] justify-center ite">
          {product.map((product, key) => (
            <div
              key={key}
              className="p-[10px] flex flex-col gap-[5px] border-t-grey border-[1px] rounded-lg w-[160px] justify-center cursor-pointer"
              onClick={keDetail}
            >
              ...
              <div className="flex flex-col gap-0">
                <h1 className="font-bold text-t-black text-[13px]">
                  {product.nama}
                </h1>
                <h2 className="font-bold text-[#D05C37] text-[10px]">
                  Rp {product.harga}
                </h2>
        ...
        {/* Rekomendasi */}
        <section className="px-4 flex justify-between items-center">
          <h className="font-semibold text-t-black text-lg">
            Recomended for you
          </h>
        </section>
        {/* Main - List Product*/}
        <main className="flex flex-wrap gap-[15px] px-[10px] justify-center ite">
          {product.slice(0, 2).map((product, key) => (
            <div
              key={key}
              className="p-[10px] flex flex-col gap-[5px] border-t-grey border-[1px] rounded-lg w-[160px] justify-center"
            >
              <div className="relative">
                <img
                  src={FotoProduct}
