  ...
  return (
    <>
      <div className="pt-5 grid gap-y-10">
        ...
        <button
          className="flex items-center justify-center flex-none px-3 py-2 md:px-4 md:py-3 border-2 rounded-[4px] font-semibold border-[#4CAF50] bg-[#8DD3BB] text-white text-sm hover:bg-[#396a59]" type="submit"
        >
          Register
        </button>
        ...
        <div className="flex items-center justify-center">
          <span className="w-14 border border-[#8DD3BB]"></span>
